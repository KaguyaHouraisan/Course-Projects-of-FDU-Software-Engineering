...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/welcome","/verifyMeetings", "/login", "/register","/startMeeting", "/contribute", "/findUserByRealname", "/findMeetingByIdentity", "/findInviteByIdentity", "/uploadFile", "/updateInvite", "/openContribute", "/closeContribute", "/getTopicByMeetingID", "/getContribute","/getConferenceByMeetingID","/*").permitAll()
