...
public class CheckService {
    ...
    private List<LoanAccount> getLoanAccountList(GetLoanAccountListRequest request) {
        if (request.getToken().equals(CheckService.getToken())) {
            ...
            if (getLoanAccountListResponse != null) {
    ...
    private List<LoanPlan> loanPlan(LoanPlanRequest request) {
        if (request.getToken().equals(CheckService.getToken())) {
            //Get方式请求
